...
public class Frogger extends WindowController{
    ...
    private static final double FROG_HEIGHT = 48.0;
	...
	f = new Frog(getImage("froggy.gif"), new Location((HIGHWAY_RIGHT-FROG_WIDTH)/2, HIGHWAY_BOTTOM + (LANE_WIDTH-FROG_HEIGHT)/2), (int) LANE_WIDTH, canvas);
	
	images.add(getImage("jeep_left.gif"));
	images.add(getImage("jeep_right.gif"));
	images.add(getImage("oldcar_left.gif"));
	images.add(getImage("oldcar_right.gif"));
	images.add(getImage("taxi_left.gif"));
	images.add(getImage("taxi_right.gif"));
	images.add(getImage("van_left.gif"));
	images.add(getImage("van_right.gif"));

	
	l = new Lane(f, canvas, images.get(0),0);
	Lane l1 = new Lane(f, canvas, images.get(2),1);
	Lane l2 = new Lane(f, canvas, images.get(5),2);
	Lane l3 = new Lane(f, canvas, images.get(7),3);
